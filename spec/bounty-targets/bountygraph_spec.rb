    ...
    expect(subject.directory_index).to eq(
      [
        ...
        },
        {
          id: 'curl',
          name: 'curl',
          description: 'curl is a command line tool and libcurl is a library - for transferring data with URLs. ' \
            'curl\'s official web site is https://curl.haxx.se'
        },
        {
          id: 'gnu-wget',
          name: 'GNU Wget',
          description: 'GNU Wget / Wget2 is a free software package for retrieving files using HTTP, HTTPS, FTP and ' \
            'FTPS: the most widely-used Internet protocols.'
        },
        {
          id: 'squid',
          name: 'Squid',
